...
public final class TestCopyByteArray {
    ...
    public static boolean whenArrayIsEmpty() {
        try {
            return CopyArray.copy(new byte[]{}, 0, 0).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundLessThanLeft() {
        try {
            CopyArray.copy(new byte[]{1, 2}, 2, 1);
    ...
    public static boolean whenRightBoundEqualLeft() {
        try {
            return CopyArray.copy(new byte[]{1, 2}, 1, 1).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundAndLeftIsZero() {
        try {
            return CopyArray.copy(new byte[]{1, 2}, 0, 0).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundAndLeftIsNegative() {
        try {
            CopyArray.copy(new byte[]{1, 2}, -1, -5);
        } catch (IllegalArgumentException e) {
    ...
    public static boolean whenDataCorrect() {
        try {
            byte[] rightAnswer = new byte[]{2, 3, 4};
            byte[] answer = CopyArray.copy(new byte[]{1, 2, 3, 4, 5}, 1, 4);
    ...
    public static void main(String[] args) {
        System.out.println("Starting copy bytes array tests");
