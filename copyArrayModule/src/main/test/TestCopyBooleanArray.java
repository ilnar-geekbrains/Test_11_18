...
public final class TestCopyBooleanArray {
    ...
    public static boolean whenArrayIsEmpty() {
        try {
            return CopyArray.copy(new boolean[]{}, 0, 0).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundLessThanLeft() {
        try {
            CopyArray.copy(new boolean[]{true, false}, 2, 1);
    ...
    public static boolean whenRightBoundEqualLeft() {
        try {
            return CopyArray.copy(new boolean[]{true, false}, 1, 1).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundAndLeftIsZero() {
        try {
            return CopyArray.copy(new boolean[]{true, false}, 0, 0).length == 0;
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean whenRightBoundAndLeftIsNegative() {
        try {
            CopyArray.copy(new boolean[]{true, false}, -1, -5);
        } catch (IllegalArgumentException e) {
    ...
    public static boolean whenDataCorrect() {
        try {
            boolean[] rightAnswer = new boolean[]{true, false, true};
            boolean[] answer = CopyArray.copy(new boolean[]{false, true, false, true, false}, 1, 4);
    ...
    public static void main(String[] args) {
        System.out.println("Starting copy booleans array tests");
